...
import suma from '../Images/mas.png'
import resta from '../Images/menos.png'
import './Menu.scss'
    ...
    return (
        <>
            <section className='sect-btn-amount'>
                <img src={resta} alt='minus' className="minus" onClick={() => {
                    removeToCart(dataProduct.id);
                    subtractCount()
                }}></img>
                <p>{count}</p>
                <img src={suma} alt='plus' className="plus" onClick={() => {
